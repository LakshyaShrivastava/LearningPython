...
class MyApp(ShowBase):
    def __init__(self):
        ...
        postInterval2 = self.pandaActor.posInterval(13, Point3(0, 10, 0), startPos=Point3(0, -10, 0))
        ...
        self.pandaPace = Sequence(posInterval1, hprInterval1, postInterval2, hprInterval2, name="pandaPase")
        self.pandaPace.loop()
