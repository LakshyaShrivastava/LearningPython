...
class GameObject():
    ...
    def cleanup(self):
        # Clearing Python Tag is important
...
class Player(GameObject):
    def __init__(self):
        GameObject.__init__(self, Vec3(0, 0, 0), "p3d_samples-master/models/act_p3d_chan",
                            {"stand": "p3d_samples-master/models/a_p3d_chan_idle",
                             "walk": "p3d_samples-master/models/a_p3d_chan_run"}, 5, 10, "player")
        ...
        self.beamModel = loader.loadModel("PandaSampleModels-master/BambooLaser/bambooLaser")
        ...
        for i in range(self.maxHealth):
            icon = OnscreenImage(image="PandaSampleModels-master/UI/health.png", pos=(-1.275 + i * 0.075, 0, 0.95),
                                 scale=0.04)

            icon.setTransparency(True)
            self.healthIcons.append(icon)

        self.beamHitModel = loader.loadModel("PandaSampleModels-master/BambooLaser/bambooLaserHit")
        ...
        self.beamHitLight.setColor(
            Vec4(0.1, 1.0, 0.2, 1))  # Values: constant, linear, quadratic coefficients for the falloff equation
        self.beamHitLight.setAttenuation((1.0, 0.1, 0.5))
        self.beamHitLightNodePath = render.attachNewNode(self.beamHitLight)

        self.damageTakenModel = loader.loadModel("PandaSampleModels-master/BambooLaser/playerHit")
    ...
    def update(self, keys, dt):
        ...
        self.groundPlane.intersectsLine(mousePos3D, render.getRelativePoint(base.camera, nearPoint),
...
class WalkingEnemy(Enemy):
    def __init__(self, pos):
        Enemy.__init__(self, pos, "PandaSampleModels-master/SimpleEnemy/simpleEnemy.egg",
                       {
                           "stand": "PandaSampleModels-master/SimpleEnemy/simpleEnemy-stand.egg",
                           "walk": "PandaSampleModels-master/SimpleEnemy/simpleEnemy-walk.egg",
                           "attack": "PandaSampleModels-master/SimpleEnemy/simpleEnemy-attack.egg",
                           "die": "PandaSampleModels-master/SimpleEnemy/simpleEnemy-die.egg",
                           "spawn": "PandaSampleModels-master/SimpleEnemy/simpleEnemy-spawn.egg"
    ...
    def updateHealthVisual(self):
        ...
        if perc < 0:
            perc = 0
        self.actor.setColorScale(perc, perc, perc, perc, 1)  # R, G, B, Alpha


class TrapEnemy(Enemy):
    def __init__(self, pos):
        Enemy.__init__(self, pos,
                       "PandaSampleModels-master/SlidingTrap/trap.egg",
                       {
                           "stand": "PandaSampleModels-master/SlidingTrap/trap-stand.egg",
                           "walk": "PandaSampleModels-master/SlidingTrap/trap-walk.egg"
                       },
                       100.0,
                       10.0,
                       "trapEnemy")
